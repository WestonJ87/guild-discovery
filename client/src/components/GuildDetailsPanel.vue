  ...
  <div>
    <article class="message">
      ...
      <div class="message-body">
        <div
          id="banner_displayer"
          v-html="selectedGuild.bannerDisplayTemplate"
        ...
        <div
          v-if="selectedGuild.description"
          class="container guild-description"
        >
          <section class="section">
            <div class="container">
              <label class="label is-small">description :</label>
              <h6 class="subtitle description">
    ...
    <article class="message is-small lieutenants">
      ...
      <div class="message-body memberslist tags is-centered">
        <span
          class="tag"
          v-for="(member, index) in selectedGuild.lieutenants"
          v-bind:key="index"
        >
          {{ member }}
        </span>
    ...
    <article class="message is-small guild-members">
      ...
      <div class="message-body memberslist tags is-centered">
        <span
          class="tag"
          v-for="(member, index) in selectedGuild.guildMembers"
          v-bind:key="index"
        >
          {{ member }}
        </span>
